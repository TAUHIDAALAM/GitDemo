...
public class Sample3 extends BaseClass {
	...
	public void testCase3() throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/div[@id='a-page']/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/span[9]/div[1]/label[1]/span[1]")).click();// to select baby

		driver.findElement(By.xpath("//button[@id='100 ac66b253-announce']")).click();//click on add to cart

		String text = driver.findElement(By.xpath("//div[contains(text(),'Added to Cart')]")).getText();//verify add to cart

		System.out.println("Actual Text 3=" +text);
